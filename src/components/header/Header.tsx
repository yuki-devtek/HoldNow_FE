    ...
    <div className="w-full h-[100px] flex flex-col justify-center items-center">
      <div className="container">
        <div className="w-full h-full flex flex-row justify-between items-center px-5">
          <div onClick={() => handleToRouter('/')} className="p-2 text-2xl text-[#64ffda] flex flex-col justify-center items-center border-[1px] border-[#64ffda] rounded-full cursor-pointer">
            <FaWolfPackBattalion />
          </div>
          {latestSwapInfo &&
            <div>
